...
import type { MattressSize, FirmnessType } from '../types';

/**
 * Firmness types available.
 */
export const FIRMNESS_TYPES: FirmnessType[] = ['firm', 'medium', 'soft'] as const;
 ...
 */
export const FIRMNESS_DISTRIBUTION: Record<MattressSize, Record<FirmnessType, number>> = {
  'King': {
    firm: 0.1356,      // 13.56%
