...
/**
 * @deprecated Use live data from settingsStore.liveSalesRates.FIRMNESS_DISTRIBUTION instead.
 *
 * This hardcoded fallback is only used by legacy algorithm files.
 * The main algorithm (fillKingQueenFirst.js) uses live Directus data.
 *
